            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  setState(
                    () {
                      var printables = rollDP(_dPAmount.round().toString(),
                          _botch, _spec, _diffAmount.round().toString());
                      _ressText = printables[0];
                      _dPText = printables[1];
                    },
                  );
                },
              ),
